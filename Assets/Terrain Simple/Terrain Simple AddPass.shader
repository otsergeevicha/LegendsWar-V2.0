...
Shader "Hidden/AmplifyShaderPack/Terrain/Simple AddPass"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float localCalculateTangentsStandard16_g14 = ( 0.0 );
			{
			v.tangent.xyz = cross ( v.normal, float3( 0, 0, 1 ) );
			v.tangent.w = -1;
			}
			float3 temp_cast_0 = (localCalculateTangentsStandard16_g14).xxx;
...
WireConnection;0;11;53;17
ASEEND*/
//CHKSM=76FEC0CF9DBD167CBD610C540361BAD14225DF4D